...
Page({
	...
	onLoad: function(options) {
		let that = this;
		wx.request({
			url: common.baseUrl+'skillServ/showDetailSkillServ',
			method: "GET",
			header: {
			...
			success(res) {
				...
				that.setData({
					...
					servType:that.data.serv[res.data.servType],
	...
	onShareAppMessage: function() {
		...
		return{
			title:that.data.servType,
			path:'/pages/skillDetail/skillDetail?bid='+bid,
